"""DEPRECATED, frozen for comparison only. Do not use in production.
...
def generate_themed_crossword_legacy(template: Dict, theme_entry: str = None, max_attempts: int = 100, backtracking_max_attempts: int = 100, word_db_manager: WordDatabaseManager = None) -> Dict:
    """
    ...
    """
    generator = LegacyCrosswordGenerator(word_db_manager)
